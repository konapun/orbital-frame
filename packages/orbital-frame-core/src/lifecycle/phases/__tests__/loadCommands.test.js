...
describe('loadCommands phase', () => {
  it('should find commands using the config service and load them with the command service', async () => {
    await loadCommands({ configService, commandService })(next)(args)
